...
Ты настраиваешь поиск на Vinted — я слежу за ним и присылаю сюда каждое новое объявление через секунды после публикации. Пока остальные обновляют страницу, ты уже пишешь продавцу.
...
💶 <b>240 EUR</b> <i>(с защитой 261.20)</i>
