...
<code>https://www.vinted.de/catalog?search_text=raf+simons&amp;price_to=300</code>`,
  ...
  'tier.welcome.pro': "ᡕᠵデ气亠\n\nТы закалён в боях и читаешь поле иначе, <b>Ranger</b> ⚔️\nТеперь {links} ссылок и проверка каждые {every}, всплеск {burst} — находки прилетают залпом, а не по одной с паузами.\nОстальные всё ещё жмут F5. 😌",
  ...
  'unit.sec': '{n} с',
  'unit.min.one': '{n} минуту',
  'unit.min.few': '{n} минуты',
  'unit.min.many': '{n} минут',
};
