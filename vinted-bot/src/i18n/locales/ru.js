...
<code>https://www.vinted.de/catalog?search_text=raf+simons&amp;price_to=300</code>`,
  ...
  'tier.welcome.basic': "▬▬ι═══════ﺤ\n\nОхота началась, <b>Hunter</b>. 🎯 Теперь {links} ссылок и проверка каждые {interval} с — хватит и на бренды, и на размеры, и на ту ценовую вилку, которую ты всё откладывал.\nРасставляй силки 🪤 — дальше моя работа.",
  'tier.welcome.pro': "ᡕᠵデ气亠\n\nТы обстрелян и читаешь поле иначе, <b>Ranger</b>. ⚔️ Проверка каждые {interval} с, {links} ссылок, всплеск {burst} — находки прилетают залпом, а не по одной с паузами.\nОстальные всё ещё жмут F5. 😌",
  'tier.welcome.turbo': "︻芫═───\n\nТы элитный снайпер — увидеть цель и снять её у тебя в крови. 🥷 Добро пожаловать на верхний уровень, <b>Sniper Elite</b>: {links} ссылок, всплеск {burst}, проверка каждые {interval} с.\nРедкая вещь достаётся тому, кто открыл её первым. Теперь это ты. 💎\nНаслаждайся)",
  'tier.welcome.elite_max': "▄︻デ══━一\n\nЭтого уровня нет в прайсе, <b>Elite Max</b>. 🔒 Проверка раз в {interval} с, {links} ссылок, всплеск {burst} — ничто из продающегося рядом не стояло.\nБольше он ни у кого. 🤫",
};
