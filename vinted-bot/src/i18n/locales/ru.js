...
<code>https://www.vinted.de/catalog?search_text=raf+simons&amp;price_to=300</code>`,
  ...
  'plan.starterLeft': 'Бесплатный день: осталось {left}',
  'plan.overLimit':
    '⚠️ Ссылок больше, чем даёт тариф — оставь {limit} в течение {left}, иначе лишние выключатся сами.',
  'limit.warned':
    '⚠️ Тариф даёт {limit} ссылок, а у тебя {active}. Оставь {limit} в течение {left} — и ничего не произойдёт; иначе самые новые лишние выключатся сами. Ничего не удаляется в любом случае.',
  'limit.enforced':
    '⏸ Выключено поисков: {paused} — чтобы уместиться в {limit} ссылок тарифа. Ничего не удалено: включить обратно можно в «📋 Мои ссылки», когда появится место.',
  ...
  'btn.contact': '✍️ Написать {handle}',
  'btn.supportRelay': '💬 Отправить отсюда',
  'support.sos': `🆘 <b>Поддержка</b>

За {handle} сидит человек, а не форма — пиши в любое время, ответ будет живой.

• <b>Нужно больше ссылок, чем даёт тариф</b> — просто попроси. Лимит — это значение по умолчанию, а не стена.
• <b>Что-то сломалось</b> — расскажи, что видел. Баги идут без очереди.
• <b>Есть идея</b> — почти всё, что этот бот умеет, начиналось с чьего-то сообщения.

Пиши на своём языке, его всё равно прочитают.`,
