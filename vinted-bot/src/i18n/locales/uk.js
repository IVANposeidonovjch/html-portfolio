...
<code>https://www.vinted.de/catalog?search_text=raf+simons&amp;price_to=300</code>`,
  ...
  'tier.welcome.basic': "▬▬ι═══════ﺤ\n\nПолювання почалося, <b>Hunter</b>. 🎯 Тепер {links} посилань і перевірка кожні {interval} с — вистачить і на бренди, і на розміри, і на ту цінову вилку, яку ти все відкладав.\nРозставляй пастки 🪤 — далі моя робота.",
  'tier.welcome.pro': "ᡕᠵデ气亠\n\nТи обстріляний і читаєш поле інакше, <b>Ranger</b>. ⚔️ Перевірка кожні {interval} с, {links} посилань, сплеск {burst} — знахідки прилітають залпом, а не по одній із паузами.\nРешта досі тисне F5. 😌",
  'tier.welcome.turbo': "︻芫═───\n\nТи елітний снайпер — побачити ціль і зняти її у тебе в крові. 🥷 Вітаю на найвищому рівні, <b>Sniper Elite</b>: {links} посилань, сплеск {burst}, перевірка кожні {interval} с.\nРідкісна річ дістається тому, хто відкрив її першим. Тепер це ти. 💎\nНасолоджуйся)",
  'tier.welcome.elite_max': "▄︻デ══━一\n\nЦього рівня ніколи не було в прайсі, <b>Elite Max</b>. 🔒 Перевірка раз на {interval} с, {links} посилань, сплеск {burst} — ніщо з того, що продається, поруч не стояло.\nБільше він ні в кого. 🤫",
};
