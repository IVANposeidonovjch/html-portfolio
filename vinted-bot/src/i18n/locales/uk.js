...
• Увімкни «Теми» — бот сам створить тему під кожен пошук.
• Канал: додай бота адміном і перешли мені будь-який допис звідти.

<b>Меню</b> — чотири кнопки: додати, мої посилання, моніторинг, довідка.
Тариф, мова та список чатів — на цьому екрані, кнопками нижче.

<b>Команди:</b> /start, /add, /help — решта кнопками.`,
