...
<code>https://www.vinted.de/catalog?search_text=raf+simons&amp;price_to=300</code>`,
  ...
  'tier.welcome.pro': "ᡕᠵデ气亠\n\nТи загартований у боях і читаєш поле інакше, <b>Ranger</b> ⚔️\nТепер {links} посилань і перевірка кожні {every}, сплеск {burst} — знахідки прилітають залпом, а не по одній із паузами.\nРешта досі тисне F5. 😌",
  ...
  'unit.sec': '{n} с',
  'unit.min.one': '{n} хвилину',
  'unit.min.few': '{n} хвилини',
  'unit.min.many': '{n} хвилин',
};
