...
<code>https://www.vinted.de/catalog?search_text=raf+simons&amp;price_to=300</code>`,
  ...
  'add.locked':
    '🔒 Зараз тарифу немає, додавати нікуди. <b>Scout</b> — тиждень за ціну кави, відкрий «Тариф» нижче.',
  ...
  'plan.starterLeft': 'Безкоштовний день: лишилось {left}',
  'plan.overLimit':
    '⚠️ Посилань більше, ніж дає тариф — залиш {limit} протягом {left}, інакше зайві вимкнуться самі.',
  'limit.warned':
    '⚠️ Тариф дає {limit} посилань, а в тебе {active}. Залиш {limit} протягом {left} — і нічого не станеться; інакше найновіші зайві вимкнуться самі. Нічого не видаляється в будь-якому разі.',
  'limit.enforced':
    '⏸ Вимкнено пошуків: {paused} — щоб уміститися в {limit} посилань тарифу. Нічого не видалено: увімкнути назад можна в «📋 Мої посилання», коли зʼявиться місце.',
  ...
  'plan.renewsOn': '🔄 Продовжується автоматично {date}',
  'plan.cancelledUntil': '⏹ Скасовано — доступ до {date}',
  'plan.renewFailed': '⚠️ Продовження не пройшло — бракує зірок. Поповни, Telegram повторить; доступ до {date}',
  'plan.invoiceDescSub': 'Кожні 30 днів · інтервал ~{seconds} сек · до {limit} посилань · скасувати можна будь-коли',
  'plan.subOffer':
    '🔄 <b>{plan}</b> — {stars} ⭐ кожні {days} днів, списується автоматично. Скасувати можна будь-коли в /plan; оплачений період доїде до своєї дати.',
  'plan.subUnavailable': '⚠️ Не вдалося відкрити підписку. Спробуй за хвилину.',
  'btn.subscribe': 'Підписатися на {plan} · {stars} ⭐',
  'btn.subCancel': '⏹ Вимкнути автопродовження',
  'btn.subResume': '🔄 Увімкнути автопродовження',
  'pay.okSub': '✅ {plan} увімкнено, продовження автоматично {date}. Скасувати можна будь-коли в /plan.',
  'sub.cancelled': '⏹ Автопродовження вимкнено. <b>{date}</b> — останній день уже оплаченого періоду, до того нічого не зміниться.',
  'sub.cancelledShort': 'Автопродовження вимкнено',
  'sub.resumed': '🔄 Автопродовження знову увімкнено.',
  'sub.resumedShort': 'Автопродовження увімкнено',
  'sub.failed': '⚠️ {plan} не продовжився — на балансі бракує {stars} ⭐. Поповни, Telegram спробує ще раз; тариф працює до <b>{date}</b>.',
  'sub.none': 'Скасовувати нема чого.',
  'sub.changeFailed': 'Telegram зараз не дав змінити підписку. Спробуй за хвилину.',
  ...
  'btn.contact': '✍️ Написати {handle}',
  'btn.supportRelay': '💬 Надіслати звідси',
  'support.sos': `🆘 <b>Підтримка</b>

За {handle} сидить людина, а не форма — пиши будь-коли, відповідь буде жива.

• <b>Потрібно більше посилань, ніж дає тариф</b> — просто попроси. Ліміт — це значення за замовчуванням, а не стіна.
• <b>Щось зламалось</b> — розкажи, що ти бачив. Баги йдуть без черги.
• <b>Є ідея</b> — майже все, що цей бот уміє, починалося з чийогось повідомлення.

Пиши своєю мовою, її все одно прочитають.`,
  ...
  'tier.welcome.basic': "▬▬ι═══════ﺤ\n\nПолювання почалося, <b>Hunter</b> 🔪\nТепер {links} посилань і перевірка кожні {every}.\nРозставляй посилання 🪤 — далі моя робота.",
  'tier.welcome.pro': "ᡕᠵデ气亠\n\nТи загартований у боях і читаєш поле інакше, <b>ranger</b> ⚔️\nТепер {links} посилань і перевірка кожні {every},\nсплеск {burst} — знахідки прилітають залпом, а не по одній із паузами.\nРешта досі тисне F5. 😌",
  'tier.welcome.turbo': "︻芫═───\n\nТи <b>Sniper Elite</b> — побачити ціль і зняти її у тебе в крові. 🩸\nВітаю у верховному ранзі🥷\n<b>Sniper Elite</b>: {links} посилань, сплеск {burst}, перевірка кожні {every}.\n\nРідкісна річ дістається тому, хто відкрив її першим. Тепер це ти. 💎\nНасолоджуйся)",
  'tier.welcome.elite_max': "▄︻デ══━一\n\nЦього рангу ніколи не було в прайсі, <b>Elite Max</b> 🔒\n{links} посилань, сплеск {burst}, перевірка кожні {every} — ніщо з того, що продається, поруч не стояло.\nБільше його ні в кого. 🤫",
